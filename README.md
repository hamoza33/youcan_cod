...
- Google Merchant API
- Docker Compose
- Caddy reverse proxy template for `gmc.shopinzo.bond`
...
- `APP_BASE_URL=https://gmc.shopinzo.bond`
...
Ensure DNS for `gmc.shopinzo.bond` points to `35.255.81.115`.
...
8. DNS confirmation for `gmc.shopinzo.bond`.
