...
export async function getConfig(): Promise<AppEnv> {
  ...
  return {
    ...
    YOUCAN_QUANTITY_OPTION_NAME: settingString(settings, 'youCan.quantityOptionName') || env.YOUCAN_QUANTITY_OPTION_NAME,
    YOUCAN_SINGLE_QUANTITY_LABEL: settingString(settings, 'youCan.singleQuantityLabel') || env.YOUCAN_SINGLE_QUANTITY_LABEL,
    ...
    AI_PROVIDER_ORDER: settingString(settings, 'ai.providerOrder') || env.AI_PROVIDER_ORDER,
    ANTHROPIC_PROVIDER_NAME: settingString(settings, 'anthropic.provider') || env.ANTHROPIC_PROVIDER_NAME,
    ANTHROPIC_BASE_URL: settingString(settings, 'anthropic.baseUrl') || env.ANTHROPIC_BASE_URL,
    ANTHROPIC_API_KEY: settingString(settings, 'anthropic.apiKey') || env.ANTHROPIC_API_KEY,
    ANTHROPIC_MODEL: settingString(settings, 'anthropic.model') || env.ANTHROPIC_MODEL,
    ...
    BRIGHTDATA_SERP_ZONE: env.BRIGHTDATA_SERP_ZONE,
